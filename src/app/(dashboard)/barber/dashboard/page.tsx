...
export default async function BarberDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      />
      <Row gutter={[16, 16]}>
        <Col xs={24} md={12} xl={6}><MetricCard title="Total" value={formatNumber(result.dashboard.total)} accentVar="--section-barber" tone="section" /></Col>
        <Col xs={24} md={12} xl={6}><MetricCard title="Activos" value={formatNumber(result.dashboard.activos)} accentVar="--section-barber" tone="success" /></Col>
